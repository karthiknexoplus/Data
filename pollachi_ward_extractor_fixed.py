#!/usr/bin/env python3
"""
Pollachi Ward Map Extractor - Fixed Version
    ...
    def save_to_csv(self, output_file='pollachi_wards.csv'):
        ...
        with open(output_file, 'w', newline='', encoding='utf-8') as csvfile:
            fieldnames = ['ward_number', 'ward_name', 'description', 'boundaries', 
                         ...
                         'representative', 'contact_info', 'general_landmarks', 
                         'general_roads', 'general_coordinates']
            ...
            for ward in self.ward_data:
                ...
                for field in ['boundaries', 'landmarks', 'roads', 'coordinates', 
                             'general_landmarks', 'general_roads', 'general_coordinates']:
